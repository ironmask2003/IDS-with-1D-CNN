...
def params(logger, test, csv_path='./Dataset/UNSW-NB15_1.csv', batch_size=64, epochs=10, lr=1e-3, num_classes=2):
...
def load_model(num_classes, model_path, device=None):
    if device is None:
        device = set_device()
